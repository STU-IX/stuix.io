  ...
  <div class="container">
    ...
    <div class="sponsor-container bronze">
      ...
      <div class="sponsor">
        ...
        <div class="name">
          <div class="en">Lazco Corporation</div>
          <div class="zh">拉資科科技有限公司</div>
        </div>
      </div>
      <div class="sponsor">
...
.sponsor-container
  ...
  &.platinum
    ...
    .sponsor
      border-bottom: 4px solid #939097
      background: linear-gradient(126.7deg,rgba(147, 144, 151, 0.1) 25%, rgba(0, 0, 0, 0.05))
      .name
        text-align: center
        font-size: 1.2rem
  &.gold
